...
class YandexMetrikaManagement:
    ...
    def counters(self) -> YandexMetrikaClientExecutor:
        ...
        & [type=<counter_type>]
        """
    def counter(self, *, counterId: Union[str, int] = None) -> YandexMetrikaClientExecutor:
        """
    ...
    def counter_undelete(
        ...
        """
    def goals(self, *, counterId: Union[str, int] = None) -> YandexMetrikaClientExecutor:
        """
    ...
    def clients(self) -> YandexMetrikaClientExecutor:
        ...
        """
    def filters(self, *, counterId: Union[str, int] = None) -> YandexMetrikaClientExecutor:
        """
    ...
    def filter(
        ...
        GET params a resource: [callback=<string>]
        """
    def operations(self, *, counterId: Union[str, int] = None) -> YandexMetrikaClientExecutor:
        """
    ...
    def operation(
        ...
        GET params a resource: [callback=<string>]
        """
    def grants(self, *, counterId: Union[str, int] = None) -> YandexMetrikaClientExecutor:
        """
        https://yandex.ru/dev/metrika/doc/api2/management/grants/grants-docpage/
        Allowed HTTP methods for requesting a resource: GET, POST
        GET params a resource: [callback=<string>]
        """
    def grant(self, *, counterId: Union[str, int] = None) -> YandexMetrikaClientExecutor:
        """
        ...
        """
    def public_grant(self, *, counterId: Union[str, int] = None) -> YandexMetrikaClientExecutor:
        """
    ...
    def set_counter_label(
        ...
        GET params a resource: None
        """
    def segments(self, *, counterId: Union[str, int] = None) -> YandexMetrikaClientExecutor:
        """
...
class YandexMetrikaStatsPageIteratorResponse(YandexMetrikaBaseMethods):
    ...
    def values(self, *, max_rows: int = None) -> Generator[list]: ...
    def dicts(self, *, max_rows: int = None) -> Generator[dict]: ...
...
class YandexMetrikaStatsResponse(YandexMetrikaBaseMethods):
    ...
    ) -> Generator[YandexMetrikaStatsPageIteratorExecutor]: ...
    def iter_values(
...
class YandexMetrikaStatsClientExecutor:
    ...
    ) -> YandexMetrikaStatsClientExecutorResponse:
        """
...
class YandexMetrikaLogsapiPageIteratorResponse(YandexMetrikaBaseMethods):
    ...
    def values(self, *, max_rows: int = None) -> Generator[list]: ...
    def dicts(self, *, max_rows: int = None) -> Generator[dict]: ...
    def lines(self, *, max_rows: int = None) -> Generator[str]: ...
...
class YandexMetrikaLogsapiResponse(YandexMetrikaBaseMethods):
    ...
    ) -> Generator[YandexMetrikaLogsapiPageIteratorExecutor]: ...
    def iter_lines(
